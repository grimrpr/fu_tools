...
\newglossaryentry{glos:Topic}{
	name=Topic,
	description={Eine asynchrone Informationsquelle oder -senke welche durch einen String repräsentiert wird, über die \glspl{glos:Node} \glspl{glos:Message} senden oder abonnieren können \cite[S. 3]{Quigley:2009kx}}
}
