...
extern const float global_min_inlier_pct; 
extern const unsigned int global_min_feature_count; 
extern const float global_max_dist_for_inliers; 
extern const bool global_drop_async_frames;
#endif
