"""autogenerated by genmsg_py from PlayBackTrackRequest.msg. Do not edit."""
...
class PlayBackTrackRequest(roslib.message.Message):
  _md5sum = "acf8b64820da9174d78f29b03e68f1ea"
  _type = "waypoint/PlayBackTrackRequest"
...
"""
  __slots__ = ['track','routeId']
  _slot_types = ['waypoint/Track','int32']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PlayBackTrackRequest, self).__init__(*args, **kwds)
...
"""autogenerated by genmsg_py from PlayBackTrackResponse.msg. Do not edit."""
import roslib.message
import struct


class PlayBackTrackResponse(roslib.message.Message):
  _md5sum = "dd11303d10a15c902ee90e582c557c03"
  _type = "waypoint/PlayBackTrackResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PlayBackTrackResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
...
class PlayBackTrack(roslib.message.ServiceDefinition):
  _type          = 'waypoint/PlayBackTrack'
  _md5sum = '6959a3defbf8e7b0c9cf47a4b9b610f1'
  _request_class  = PlayBackTrackRequest
  _response_class = PlayBackTrackResponse
