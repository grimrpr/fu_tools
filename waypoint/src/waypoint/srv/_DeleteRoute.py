"""autogenerated by genmsg_py from DeleteRouteRequest.msg. Do not edit."""
...
class DeleteRouteRequest(roslib.message.Message):
  _md5sum = "2afa910865e3f3395af09556a72f9764"
  _type = "waypoint/DeleteRouteRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DeleteRouteRequest, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    """
    try:
      buff.write(_struct_i.pack(self.route.routeId))
      _x = self.route.trackName
      length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.route.routeId,) = _struct_i.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      end += length
      self.route.trackName = str[start:end]
      _x = self
      start = end
      end += 12
...
"""autogenerated by genmsg_py from DeleteRouteResponse.msg. Do not edit."""
import roslib.message
import struct


class DeleteRouteResponse(roslib.message.Message):
  _md5sum = "dd11303d10a15c902ee90e582c557c03"
  _type = "waypoint/DeleteRouteResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DeleteRouteResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
...
class DeleteRoute(roslib.message.ServiceDefinition):
  _type          = 'waypoint/DeleteRoute'
  _md5sum = 'f7f28c61de511fe3e3e52f59f1aba4a6'
  _request_class  = DeleteRouteRequest
  _response_class = DeleteRouteResponse
