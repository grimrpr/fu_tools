"""autogenerated by genmsg_py from GenerateTrackRequest.msg. Do not edit."""
...
class GenerateTrackRequest(roslib.message.Message):
  _md5sum = "ced2a03df6c041bfa712464c6ce00675"
  _type = "waypoint/GenerateTrackRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GenerateTrackRequest, self).__init__(*args, **kwds)
...
"""autogenerated by genmsg_py from GenerateTrackResponse.msg. Do not edit."""
import roslib.message
import struct
...
class GenerateTrackResponse(roslib.message.Message):
  _md5sum = "ced2a03df6c041bfa712464c6ce00675"
  _type = "waypoint/GenerateTrackResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """Track track
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GenerateTrackResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.track is None:
        self.track = waypoint.msg.Track()
    else:
...
_struct_2I = struct.Struct("<2I")
_struct_3d = struct.Struct("<3d")
class GenerateTrack(roslib.message.ServiceDefinition):
  _type          = 'waypoint/GenerateTrack'
  _md5sum = '314382d049948164707d1737371de048'
  _request_class  = GenerateTrackRequest
  _response_class = GenerateTrackResponse
